...
public class NewestRecyclerViewAdapter extends RecyclerView.Adapter<NewestRecyclerViewAdapter.ViewHolder> {
    ...
    public NewestRecyclerViewAdapter(Context context, ArrayList<Manga> manga) {
    ...
    @Override
    public void onBindViewHolder(@NonNull NewestRecyclerViewAdapter.ViewHolder holder, int position) {
