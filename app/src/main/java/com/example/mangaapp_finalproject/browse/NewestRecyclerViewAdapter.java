...
public class NewestRecyclerViewAdapter extends RecyclerView.Adapter<NewestRecyclerViewAdapter.ViewHolder> {
    ...
    public NewestRecyclerViewAdapter(Context context, Manga[] manga) {
    ...
    @NonNull
    @Override
    public NewestRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.horizontal_item_row, parent, false);
        return new NewestRecyclerViewAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull NewestRecyclerViewAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        String coverLink = "";
